  ...
  return (
    <>
      ...
      <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
        {msg && <Alerta alerta={alerta} />/*si hay algo en msg que se muestre sino vacio */}
        {tokenValido && (
          <>
        ...
        {passwordModificado &&  <Link to="/" className="block text-center my-5 text-gray-600"> Inicia sesion</Link>}
      </div>
    </>
